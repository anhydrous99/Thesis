...
\begin{figure}
	\centering
	\includegraphics[scale=0.75]{NNDiagram}
...
$$w_m(t+1)\leftarrow w_m(t)-\gamma\frac{\hat{k}_m}{\sqrt{\hat{v_m}}+\epsilon} \cite{kingma_ba_2017}.$$
