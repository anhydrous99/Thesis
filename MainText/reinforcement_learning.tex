...
\begin{algorithm}
	...
	\For{$t=1,T$}{
		...
		$y\leftarrow \begin{cases}r & t=T \\ r + \gamma max_{b\in A} \hat{Q}(s,b)& \text{otherwise}\end{cases}$\\
...
An alternative to Q-Learning methods is Policy Optimization methods. One of the simplest is REINFORCE. 
